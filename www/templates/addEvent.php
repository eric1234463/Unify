...
<ion-view title="Create Event" ng-form="eventForm">
    ...
    <ion-content class="background">
        <div class="card padding-top">
            ...
            <label class="item item-input item-stacked-label">
                ...
                <input type="text" placeholder="i.e Course Code" ng-model="addEvent.eventDescription">
            </label>
            <label class="item item-input item-stacked-label">
                <span class="input-label">Location</span>
                <input type="text" placeholder="i.e. KEC469" ng-model="addEvent.eventLocation">
            </label>
        </div>
        <div class="card" ng-init="addEvent.isAllDay='false'">
            <ion-toggle class="item" ng-true-value='1' ng-false-value='0' ng-model="addEvent.isAllDay">
            ...
            <ion-toggle class="item" ng-true-value='1' ng-false-value='0' ng-model="addEvent.isPersonal">Personal Event</ion-toggle>
